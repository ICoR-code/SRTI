function [gaPN,gvPN,gaWN,gvWN,gaGN,gvGN] = getGM_2 (nodePN,nodeWN,nodeGN,timestamp)
...
[gaPN,gvPN,gaWN,gvWN,gaGN,gvGN] = getAttenGM_NW(nodePN,nodeWN,nodeGN,...
...
function [gaPN,gvPN,gaWN,gvWN,gaGN,gvGN] = getAttenGM_NW(nodePN,nodeWN,nodeGN,referPointXY,ga_scaled,gv_scaled,epicenterXY)
% dt = 0.01; % sec
