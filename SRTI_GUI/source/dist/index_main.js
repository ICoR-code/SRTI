		...
		resizePanel( document.getElementById("seperator2"), "H" );
		...
		*/
		function resizePanel( element, direction, handler )
		{
		  ...
		  console.log("" + element.getAttribute("id"));
			if (element.getAttribute("id") == "seperator2"){
		...
		*/
		function AddNewObjectSimulator2(){
			...
			if (editExistingObject == -1){
				listOfSimulators.push({name:newSimName, 
		...
		*/
		function UpdateObjectToMessageDef(){
			var panel = document.getElementById("modalNewMessagePanel1");
			while (panel.firstChild){
				panel.removeChild(panel.firstChild);
			}
			let i = 0;
			for (i = 0; i < listOfMessageObjects.length; i++){
				...
				addContent2.onclick = function(){
					console.log("onclick at index = " + this.id);
					RemoveObjectToMessageDef(this.id);
				};
				addContent2.style = "float:right;";
				var addContent3 = document.createTextNode("X");
				addContent2.appendChild(addContent3);
		...
		*/
		function RemoveObjectToMessageDef(btn_id){
		...
		*/
		...
		function AddToUndoBuffer(description){
			...
			textConsoleLastAction.innerHTML = "Added to undo buffer stack: " + description;
		}
		...
		function Undo(){
			...
			var textConsoleLastAction = document.getElementById("TextConsoleLastAction");
			textConsoleLastAction.innerHTML = "Attempting to undo something...";
			if (undoStack.length == 0){
				textConsoleLastAction = document.getElementById("TextConsoleLastAction");
